...
from database.repositories.country_risk_repository import CountryRiskRepository
from database.repositories.feedback_repository import FeedbackRepository
from database.repositories.final_report_repository import FinalReportRepository
from database.repositories.kyc_repository import KYCRepository
from database.repositories.servicelink_repository import ServiceLinkRepository
from database.repositories.sharepoint_repository import SharePointRepository
...
class DatabaseConfig(NamedTuple):
    ...
    def from_env(cls) -> "DatabaseConfig":
        return cls(
            db_path=os.environ.get("SQLITE_DB_PATH", "data/kyc_database.db")
        )
