...
utils/state.py
───────────────
Typed pipeline state. Created once in the orchestrator,
threaded through every pipeline and agent.

Each field maps directly to a step output from your original data_analyst.py.
"""
